...
//        [InlineData(typeof(BuiltIn.ConditionFunctions), nameof(ConditionFunctions.IsDaylightSavingTime), new object[] { "2015-09-24T21:22:48.2698750Z" }, false)]
        ...
        {
            var minFunction = Functions.GetFunction(typeof(AggregateFunctions<>).FullName, nameof(AggregateFunctions<int>.Min)).GetTransformFunction(typeof(DateTime)); 
            var maxFunction = Functions.GetFunction(typeof(AggregateFunctions<>).FullName, nameof(AggregateFunctions<int>.Max)).GetTransformFunction(typeof(DateTime)); 
        ...
        public void FastEncryptTest()
        {
            ...
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.FastEncrypt)).GetTransformFunction(typeof(string), null, globalVariables);
            var encrypted = function.RunFunction(new object[] {value});

            function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.FastDecrypt)).GetTransformFunction(typeof(string),null , globalVariables);
        ...
        public void StrongEncryptTest()
        {
            var globalVariables = new GlobalVariables("abc");
            const string value = "encrypt this";
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.StrongEncrypt)).GetTransformFunction(typeof(string), null, globalVariables);
            var encrypted = function.RunFunction(new object[] {value});

            function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.StrongDecrypt)).GetTransformFunction(typeof(string), null, globalVariables);
            var decrypted = function.RunFunction(new[] {encrypted});
        ...
        public void EncryptTest()
        {
            ...
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.Encrypt)).GetTransformFunction(typeof(string));
            var encrypted = function.RunFunction(new object[] {value, key, iterations});

            function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.Decrypt)).GetTransformFunction(typeof(string));
        ...
        public void HashTest()
        {
            ...
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.SecureHash)).GetTransformFunction(typeof(string));
            var hashed = function.RunFunction(new object[] {value});

            function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.ValidateSecureHash)).GetTransformFunction(typeof(string));
            var passed = (bool)function.RunFunction(new [] {value, hashed});

            Assert.True(passed);
            
            //check hash fails with different value.
            passed = (bool) function.RunFunction(new [] {"hash thiS", hashed});
            Assert.False(passed);
        }
        ...
        {
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.CreateSHA1)).GetTransformFunction(typeof(string));
...
//            Assert.NotEqual(bigsha, bigsha2);
        ...
        {
            var function = Functions.GetFunction(typeof(AggregateFunctions<int>).FullName, nameof(AggregateFunctions<int>.Count)).GetTransformFunction(typeof(int)); 
        ...
        {
            var function = Functions.GetFunction(typeof(AggregateFunctions<string>).FullName, nameof(AggregateFunctions<string>.ConcatAgg)).GetTransformFunction(typeof(string)); 
        ...
        public void Function_XPathValue()
        {
            ...
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.XPathValues)).GetTransformFunction(typeof(XmlDocument));
        ...
        {
            //Get a rows that exists.
            var function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.JsonValues)).GetTransformFunction(typeof(JToken));
            ...
            function = Functions.GetFunction(typeof(MapFunctions).FullName, nameof(MapFunctions.JsonValues)).GetTransformFunction(typeof(JToken));
        ...
        public void RowFunctions_GenerateSequence()
        {
            ...
            var function = Functions.GetFunction(typeof(RowFunctions).FullName, nameof(RowFunctions.GenerateSequence)).GetTransformFunction(typeof(int));
        ...
        {
            //Use a for loop to simulate gen sequence.
            var function = Functions.GetFunction(typeof(RowFunctions).FullName, nameof(RowFunctions.SplitColumnToRows)).GetTransformFunction(typeof(string));
        ...
        public void RowFunctions_XPathNodesToRows()
        {
            ...
            var function = Functions.GetFunction(typeof(RowFunctions).FullName, nameof(RowFunctions.XPathNodesToRows)).GetTransformFunction(typeof(XmlDocument));
            var xmlDoc = Operations.Parse<XmlDocument>("<root><row>0</row><row>1</row><row>2</row><row>3</row><row>4</row><row>5</row></root>");
        ...
        {
            //Use a for loop to similate gen sequence.
            var function = Functions.GetFunction(typeof(RowFunctions).FullName, nameof(RowFunctions.JsonElementsToRows)).GetTransformFunction(typeof(JToken));
        ...
        {
            //Use a for loop to simulate gen sequence.
            var function = Functions.GetFunction(typeof(RowFunctions).FullName, nameof(RowFunctions.JsonPivotElementToRows)).GetTransformFunction(typeof(JToken));
        ...
        public void GroupFunction_ParentChildFlatten()
        {
            ...
            var function = Functions.GetFunction(typeof(HierarchyFunctions).FullName, nameof(HierarchyFunctions.FlattenParentChild)).GetTransformFunction(typeof(string));
