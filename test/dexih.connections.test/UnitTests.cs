    ...
    public class UnitTests
    {
        ...
        public void Unit(Connection connection, string databaseName)
        {
            ...
            if (connection.DatabaseCategory == Connection.ECategory.File)
            {
                ...
                int rowCount = 0;
                var filereaderResult = fileReader.Open().Result;
            ...
            connection.DataWriterFinish(table).Wait();
            ...
            //    var filemoveResult = fileConnection.MoveFile(table, filename, table.GetExtendedProperty("Archive"), table.GetExtendedProperty("Incoming")).Result;
            //}
