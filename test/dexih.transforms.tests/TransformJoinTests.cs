...
namespace dexih.transforms.tests
{
    public class TransformJoinTests
    {
        ...
        public async Task JoinSorted()
        {
            ...
            var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.NullJoin, null, "Join");
            ...
            Assert.True(transformJoin.JoinAlgorithm == EJoinStrategy.Sorted);
        ...
        public async Task JoinHash()
        {
            var source = Helpers.CreateSortedTestData();
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, Helpers.CreateUnSortedJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.NullJoin, null, "Join");
        ...
        public async Task JoinSortedFilter()
        {
            ...
            var mappings = new Mappings { new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn")) };
            var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.Filter, null, "Join");
            // var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinData(), new List<Join> { new Join(new TableColumn("StringColumn"), new TableColumn("StringColumn")) }, null, EDuplicateStrategy.Abend, null, "Join");
            Assert.Equal(9, transformJoin.FieldCount);
        ...
        public async Task JoinHashFilter()
        {
            var source = Helpers.CreateSortedTestData();
            var mappings = new Mappings { new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn")) };
            var transformJoin = new TransformJoin(source, Helpers.CreateUnSortedJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.Filter, null, "Join");
            // var transformJoin = new TransformJoin(source, Helpers.CreateUnSortedJoinData(), new List<Join> { new Join(new TableColumn("StringColumn"), new TableColumn("StringColumn")) }, null, EDuplicateStrategy.Abend, null, "Join");
        ...
        public async Task JoinSortedAbend()
        {
            ...
            var mappings = new Mappings { new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn")) };
            var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.Abend, null, "Join");
            // var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinData(), new List<Join> { new Join(new TableColumn("StringColumn"), new TableColumn("StringColumn")) }, null, EDuplicateStrategy.Abend, null, "Join");
            Assert.Equal(9, transformJoin.FieldCount);
        ...
        public async Task JoinHashAbend()
        {
            var source = Helpers.CreateSortedTestData();
            var mappings = new Mappings { new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn")) };
            var transformJoin = new TransformJoin(source, Helpers.CreateUnSortedJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.Abend, null, "Join");
            // var transformJoin = new TransformJoin(source, Helpers.CreateUnSortedJoinData(), new List<Join> { new Join(new TableColumn("StringColumn"), new TableColumn("StringColumn")) }, null, EDuplicateStrategy.Abend, null, "Join");
        ...
        public async Task JoinHashDuplicate()
        {
            var source = Helpers.CreateSortedTestData();
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, Helpers.CreateDuplicatesJoinData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.NullJoin, null, "Join");
        ...
        public async Task JoinSortedDuplicate()
        {
            ...
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, sortedJoinData, mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.NullJoin, null, "Join");
        ...
        public async Task JoinSortedMissingJoinRow()
        {
            ...
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinDataMissingRows(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.NullJoin, null, "Join");
        ...
        public async Task JoinSortedOuterJoin()
        {
            ...
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, sortedJoinData, mappings, EJoinStrategy.Auto, EDuplicateStrategy.All, EJoinNotFoundStrategy.NullJoin, null, "Join");
...
//            var transformJoin = new TransformJoin(source, sortedJoinData, new List<Join> { new Join(new TableColumn("StringColumn"), new TableColumn("StringColumn")) }, conditions, EDuplicateStrategy.Abend, null, "Join");
        ...
        public async Task JoinPreSortFirstFilter()
        {
            ...
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, sortedJoinData, mappings, EJoinStrategy.Auto, EDuplicateStrategy.First, EJoinNotFoundStrategy.NullJoin, new TableColumn("LookupValue", ETypeCode.String, parentTable: "Join"), "Join");
            ...
            await transformJoin.Open(1, null, CancellationToken.None);
            Assert.Equal(EJoinStrategy.Sorted, transformJoin.JoinAlgorithm);
        ...
        public async Task JoinPreSortLastFilter()
        {
            ...
            var mappings = new Mappings {new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn"))};
            var transformJoin = new TransformJoin(source, sortedJoinData, mappings, EJoinStrategy.Auto, EDuplicateStrategy.Last, EJoinNotFoundStrategy.NullJoin, new TableColumn("LookupValue", ETypeCode.String, parentTable: "Join"), "Join");
...
//            var transformJoin = new TransformJoin(source, sortedJoinData, new List<Join> { new Join(new TableColumn("StringColumn"), new TableColumn("StringColumn")) }, null, EDuplicateStrategy.Last, new TableColumn("LookupValue", ETypeCode.String, "Join"), "Join");
        ...
        public async Task JoinSortedStaticValue()
        {
            ...
            var transformJoin = new TransformJoin(source, sortedJoinData, mappings, EJoinStrategy.Auto, EDuplicateStrategy.Abend, EJoinNotFoundStrategy.NullJoin, new TableColumn("LookupValue", ETypeCode.String, parentTable: "join_duplicates"), "join_duplicates");
            Assert.Equal(10, transformJoin.FieldCount);
...
//            var transformJoin = new TransformJoin(source, Helpers.CreateSortedJoinData(), null, conditions, EDuplicateStrategy.Abend, null, "Join");
            ...
            await transformJoin.Open(1, null, CancellationToken.None);
            Assert.Equal(EJoinStrategy.Hash, transformJoin.JoinAlgorithm);
...
//            var transformJoin = new TransformJoin(source, Helpers.CreateUnSortedJoinData(), null, conditions, EDuplicateStrategy.Abend, null, "Join");
        ...
        public async Task Join_LinkArray()
        {
            ...
            var link = new TransformJoin(source, Helpers.CreateChildTableData(), mappings, EJoinStrategy.Auto, EDuplicateStrategy.All, EJoinNotFoundStrategy.NullJoin, null, "Join");
        ...
        public async Task JoinMergeValidDates()
        {
            ...
            var mappings = new Mappings { new MapJoin(new TableColumn("StringColumn"), new TableColumn("StringColumn")) };
            var transformJoin = new TransformJoin(source, sortedJoinData, mappings, EJoinStrategy.Auto, EDuplicateStrategy.MergeValidDates, EJoinNotFoundStrategy.NullJoin, null, "Join");
