...
//
//        public static TransformFunction GetProfileReference(bool detailedResults, string profileName, TableColumn inputColumn)
//        {
//            var newProfile = new StandardProfiles(detailedResults);
//            return new TransformFunction(newProfile, profileName, profileName + "Result", "Reset", new[] { inputColumn }, new TableColumn("Result"), new[] { new TableColumn("Distribution") });
//        }
//
//        public static TransformFunction GetProfileReference(bool detailedResults, string profileName, string inputColumnName)
//        {
//            var newProfile = new StandardProfiles(detailedResults);
//            var function = new TransformFunction(newProfile, profileName, profileName + "Result", "Reset", new[] { new TableColumn(inputColumnName) }, new TableColumn("Result"), new[] { new TableColumn("Distribution") });
