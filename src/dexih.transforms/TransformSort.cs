...
namespace dexih.transforms
{
    public class TransformSort : Transform
    {
        ...
        protected override bool ReadRecord()
        {
            ...
            {
                _sortedDictionary = new SortedDictionary<object[], object[]>(new SortKeyComparer());
                ...
                while (Reader.Read())
                {
                    ...
                    sortFields[sortFields.Length-1] = rowcount; //add row count as last key field to ensure uniqueness.
